...
import { FrontendDeveloper } from 'ftmamhmod';
import { ReactJS , NextJS} from '@/skills';

function createAmazingWebsite() {
  const mySkills = {
    webDev: ["Next.js", "React", "TS"],
    passion: "Creating visually appealing and intuitive interfaces."
  };

  return {
    message: "Let's work together!",
    services: [" Building Web sites",],
